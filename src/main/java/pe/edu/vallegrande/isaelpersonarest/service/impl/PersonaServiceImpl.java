package pe.edu.vallegrande.isaelpersonarest.service.impl;

import lombok.RequiredArgsConstructor;
import org.springframework.stereotype.Service;
import pe.edu.vallegrande.isaelpersonarest.model.Persona;
import pe.edu.vallegrande.isaelpersonarest.repository.PersonaRepository;
import pe.edu.vallegrande.isaelpersonarest.service.PersonaService;
    ...
    public Mono<Persona> update(Long id, Persona persona) {
        return repository.findById(id)
                .flatMap(existing -> {
                    ...
                    existing.setApellido(persona.getNombre());
